...
namespace Commons
{
    public class OSystems
    {
        ...
        public DataTable DataThanhPho(bool coAll)
        {
            //ID_TP,TEN_TP
            DataTable dt = new DataTable();
            dt.Load(SqlHelper.ExecuteReader(Commons.IConnections.CNStr, "spGetComboThanhPho", Commons.Modules.UserName, Commons.Modules.TypeLanguage, coAll));
            return dt;
        }
